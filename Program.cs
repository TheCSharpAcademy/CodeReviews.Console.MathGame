...
bool HasWon()
{
    ...
    if (guess != null)
    {
        ...
        {
            if (gameSelector == "1" && AdditionGame() == answer)
            {
                Console.WriteLine("Congratulations! You guessed correctly!");
                wonGame = true;
            }
            else if (gameSelector == "2" && SubtractionGame() == answer)
            {
                Console.WriteLine("Congratulations! You guessed correctly!");
                wonGame = true;
            }
            else if (gameSelector == "3" && MultiplicationGame() == answer)
            {
                Console.WriteLine("Congratulations! You guessed correctly!");
                wonGame = true;
            }
            else if (gameSelector == "4" && DivisionGame() == answer)
            {
                Console.WriteLine("Congratulations! You guessed correctly!");
                wonGame = true;
            }
