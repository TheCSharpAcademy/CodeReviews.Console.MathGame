...
do
{
    ...
    if (userInput != null)
    {
        ...
        if (validInput)
            ...
            {
                case 1:
                    gameHistory.Add(new List<string>{"Multiplication"}); //Add title.
                    Multiplication(); //Call method.
                    break;

                case 2:
                    gameHistory.Add(new List<string>{"Division"}); //...
                    Division(); //...
                    break;

                case 3:
                    gameHistory.Add(new List<string>{"Addition"}); //...
                    Addition(); //...
                    break;

                case 4:
                    gameHistory.Add(new List<string>{"Subtraction"}); //...
                    Subtraction();
                    break; //...
